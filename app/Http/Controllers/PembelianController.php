...
class PembelianController extends Controller
{
    ...
    {
        $user = Auth::user();
        Pembelian::where('faktur', $request->id)->update(['type' => 'z','username' => $user->name,'user_id' => $user->id]);
        Mutasi::where('nomor_transaksi', $request->id)->update(['type' => 'z','username' => $user->name,'user_id' => $user->id]);
