...
@extends('layouts.main',['label'=>'Data penjualans'])
              ...
              <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-4">
                    <a   href="{{ route('penjualan.create') }}"class="btn mt-2 btn-login w-75 btn-success">Tambah penjualan</a>
                  </div>
                    ...
                    cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                      ...
                      <tbody>
                        ...
                        <tr class="odd">
                          ...
                          <td>
                            {{ tanggal_indonesia($penjualan->tanggal_penjualan, false) }}
                          </td>
                          <td class=" ">
                              <a href="{{ route('penjualan.edit', $penjualan->faktur) }}" data-bs-toggle="tooltip" title="Edit" class="p-2"><i class="fa fa-edit text-primary "></i>
                                </a>
                                <a href="#"  data-id="{{ $penjualan->faktur }}"   data-toggle="modal" data-target="#deleteModal" title="Hapus"
                ...
                <div class="row justify-content-between">
                  <div class="col-sm-12 col-md-5 mb-3">
                    <div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
                      Showing {{ $penjualans->firstItem() }}  to {{ $penjualans->lastItem() }}  of  {{ $penjualans->total() }}  entries
                    </div>
                  </div>
...
<form action="/hapus-penjualan" method="post">
  @csrf
