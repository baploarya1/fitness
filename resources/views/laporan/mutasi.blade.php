                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                @component('components.inputDate',['label'=>'Tanggal Akhir',"name"=>"tgl_akhir" ,"placeholder"=>"Last name", "value"=>$current]) @endcomponent
                                      ...
                                      <div class="card">
                                        <div class="card-body">
                                            @component('components.select',['label'=>'Aksesoris',"type"=>"obj","name"=>"kode_aksesoris" ,'key1'=>'kode_aksesoris','key2'=>'nama_aksesoris','key3'=>'kode_aksesoris', 'key4'=>'satuan','col'=>'col-lg-8 col-sm-6',"placeholder"=>"Pilih Aksesoris", "options"=>$aksesoris])  @endcomponent   
