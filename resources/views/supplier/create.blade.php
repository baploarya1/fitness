    ...
    <div class="card">
        <div class="card-body">
             <form class='mt-2' enctype="multipart/form-data" action="{{ route('supplier.store') }}" id="myForm" method="POST">
                ...
                @component('components.inputGroup',['label'=>'Kode Supplier ',"name"=>"kode_supplier","col"=>"col-md-5"]) @endcomponent
                @component('components.inputGroup',['label'=>'Nama Supplier ',"name"=>"nama_supplier","col"=>"col-md-5"]) @endcomponent
                @component('components.textarea',['label'=>'Alamat ',"name"=>"alamat","col"=>"col-md-5"]) @endcomponent
                @component('components.inputGroup',['label'=>'Nomor Handphone ',"name"=>"no_hp","col"=>"col-md-5"]) @endcomponent

                @component('components.inputGroup',['label'=>'Nama Kontak ',"name"=>"nama_kontak","col"=>"col-md-5"]) @endcomponent
                    <hr>
